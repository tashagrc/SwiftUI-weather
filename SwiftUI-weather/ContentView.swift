...
struct ContentView: View {
    ...
    var body: some View {
        // background area
        ZStack {
            // dikasih tanda $ agar binding dgn var yg di atasnya
...
struct BackgroundView: View {
    // binding utk nandain klo ini sama kayak variabel di atasnya
    // kalo kyk gini doang krg berguna, harusnya bisa dari sini ubah variabel jg trs keubah di globalnya
